...
const CACHE_NAME = 'plm-v1.0.0';
const SHELL = ['./', './index.html', './app.css', './app.js', './channels.js', './engine.js', './store.js', './exporter.js', './ai.js', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png'];
